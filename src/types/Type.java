...
public abstract class Type
{
    ...
    public boolean isSameType(Type other)
    {
        ...
        if (this instanceof TypeInt && other instanceof TypeInt) return true;
        if (this instanceof TypeString && other instanceof TypeString) return true;
        if (this instanceof TypeVoid && other instanceof TypeVoid) return true;
    ...
    public boolean canAssignTo(Type target)
    {
        ...
        if (isSameType(target)) return true;
        ...
        {
            TypeClass thisClass = (TypeClass) this;
